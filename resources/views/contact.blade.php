...
<div class="background">
  ...
  <div class="firstsection" id="home">
    <div class="box-main">
      ...
      <div class="button">
        <button class="butn">contact us</button>
      </div>
    </div>
  </div>
</div>
...
<div class="about-section global-section">
  <div class="get container">
    <div class="row">
      <div class="col-12">
        <h5 data-aos="fade-right" class="aos-init aos-animate">Contact us.</h5>
        <p data-aos="fade-left" class="aos-init aos-animate"> "Applligent Technologies came to life with a clear goal: to use technology to transform businesses and enhance lives. From day one, we've focused on creating top-notch software solutions to help companies thrive in the digital age. We started small, just a group of coders with big dreams. Today, we've grown into a well-known software company serving clients across various industries, with a presence around the globe." </br>
        "Even though we've grown rapidly, we remain committed to what matters most: honesty, fairness, and delivering exceptional work. These principles guide every task we undertake and shape how we interact with partners, clients, and our team."</p>
