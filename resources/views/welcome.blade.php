  ...
  <div class="container">
    <div class="row mt-3 mt-sm-5">
      ...
      <div class="col-lg-3 col-12 col-sm-6">
        <div class="card">
          <img class="img-icon" src="{{ asset('assets/images/about-icon-1.png') }}" class="card-img-top" alt="logo" width="78" height="78">
          <img class="img-hover-icon" src="{{ asset('assets/images/about-hover-icon-1.png') }}" class="card-img-top" alt="logo" width="78"
            height="78">
          <div class="card-b">
      ...
      <div class="col-lg-3 col-12 col-sm-6">
        <div class="card">
          <img class="img-icon" src="{{ asset('assets/images/about-icon-2.png') }}" class="card-img-top" alt="logo" width="78" height="78">
          <img class="img-hover-icon" src="{{ asset('assets/images/about-hover-icon-2.png') }}" class="card-img-top" alt="logo" width="78"
            height="78">
          <div class="card-b">
      ...
      <div class="col-lg-3 col-12 col-sm-6">
        <div class="card">
          <img class="img-icon" src="{{ asset('assets/images/about-icon-3.png') }}" class="card-img-top" alt="..." width="78" height="78">
         
          <img class="img-hover-icon" src="{{ asset('assets/images/about-hover-icon-3.png') }}" class="card-img-top" alt="logo" width="78"
            height="78">
          <div class="card-b">
      ...
      <div class="col-lg-3 col-12 col-sm-6">
        <div class="card">
          <img class="img-icon" src="{{ asset('assets/images/about-icon-4.png') }}" class="card-img-top" alt="..." width="78" height="78">
          <img class="img-hover-icon" src="{{ asset('assets/images/about-hover-icon-4.png') }}" class="card-img-top" alt="logo" width="78"
            height="78">
          <div class="card-b">
...
<div class="contact-section" id="contact-section">
  <div class="contact-us-section">
    <div class="first-half">
      <img src="{{ asset('assets/images/contact-banner.png') }}" alt="contact">
    </div>
    ...
    <div class="row">
      <div class="col-lg-6 left_section">
        <div class="footer_logo mb-4 mt-4"><img alt="app expedition logo" loading="lazy" width="155" height="65"
            decoding="async" data-nimg="1" style="color:transparent" src="{{ asset('assets/images/logo.png') }}">
        </div>
