...
<div class="background">
 ...
 <div class="section global-section">
  <div class="container">
    <div class="about">
      <h1 class="about-heading aos-init aos-animate" data-aos="fade-right">Why Choose App Expedition For
        Your App or Website Development?</h1>
      <p class="about-para" data-aos="fade-left" class="aos-init aos-animate">As one of the fastest-growing software
        development companies in the Americas, our team of
        enthusiastic technologists focus bringing real solutions through a deep understanding of our client’s need and
        technologies. We make sure we work around the clock through mvp consulting, design, development, testing, and
        marketing. We will never leave you high and dry and will work around your budget constraints. We also will
        give
        you 6 months of free maintnence after completion.</p>
    </div>
  </div>
  <div class="container">
    <div class="row mt-3 mt-sm-5">
      ...
      <div class="col-lg-3 col-12 col-sm-6">
        <div class="card">
          <img class="img-icon" src="<?php echo e(asset('assets/images/about-icon-1.png')); ?>" class="card-img-top" alt="logo" width="78" height="78">
          <img class="img-hover-icon" src="<?php echo e(asset('assets/images/about-hover-icon-1.png')); ?>" class="card-img-top" alt="logo" width="78"
            height="78">
          <div class="card-b">
            <h5 class="card-t"> Budget Friendly with
              monthly plans</h5>
            <p class="card-p">We are happy to work with you
              to designate a monthly plan.</p>
      ...
      <div class="col-lg-3 col-12 col-sm-6">
        <div class="card">
          <img class="img-icon" src="<?php echo e(asset('assets/images/about-icon-2.png')); ?>" class="card-img-top" alt="logo" width="78" height="78">
          <img class="img-hover-icon" src="<?php echo e(asset('assets/images/about-hover-icon-2.png')); ?>" class="card-img-top" alt="logo" width="78"
            height="78">
          <div class="card-b">
            <h5 class="card-t">6 Month Free Bug
              Maintenance</h5>
            <p class="card-p">We will provide you free 6 month
              bug Maintenance after
              your app is developed.</p>
      ...
      <div class="col-lg-3 col-12 col-sm-6">
        <div class="card">
          <img class="img-icon" src="<?php echo e(asset('assets/images/about-icon-3.png')); ?>" class="card-img-top" alt="..." width="78" height="78">
         
          <img class="img-hover-icon" src="<?php echo e(asset('assets/images/about-hover-icon-3.png')); ?>" class="card-img-top" alt="logo" width="78"
            height="78">
          <div class="card-b">
            <h5 class="card-t">Our Developers are
              experts</h5>
            <p class="card-p">We employ a team of experts
              to build your app and website </p>
          </div>
        </div>
      </div>
      <div class="col-lg-3 col-12 col-sm-6">
        <div class="card">
          <img class="img-icon" src="<?php echo e(asset('assets/images/about-icon-4.png')); ?>" class="card-img-top" alt="..." width="78" height="78">
          <img class="img-hover-icon" src="<?php echo e(asset('assets/images/about-hover-icon-4.png')); ?>" class="card-img-top" alt="logo" width="78"
            height="78">
          <div class="card-b">
            <h5 class="card-t">We work around the
              clock for your needs.</h5>
            <p class="card-p">We will work non-stop until your
              app is published</p>
          </div>
...
<?php /**PATH E:\example-app\resources\views/welcome.blade.php ENDPATH**/ ?>